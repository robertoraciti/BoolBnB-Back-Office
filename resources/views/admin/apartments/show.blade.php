...
@section('content')
    <div class="container mt-5">
        ...
        <div class="row ">
            ...
            <div class="col-12 mt-3 no-p">
                <p class="ms-yellow form-label border">Description:</p>
        ...
        <div class="row border mt-5">
            <label class="form-label ms-lightblue">Services:</label>
        ...
        <div class="row mt-5">
            <div class="col-6">
                <p>
                    ...
                    @foreach ($apartment->advertisements as $advertisement)
                        <br>
