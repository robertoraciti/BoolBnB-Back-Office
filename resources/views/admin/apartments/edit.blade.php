...
@section('content')
                        ...
                        <div class="row row-cols-3">
                            <div class="col-3">
                                ...
                                <input type="number" min="0"
                                    ...
                                    value="{{ old('rooms') ?? $apartment->rooms }}" data-parsley-type="number"
                            ...
                            <div class="col-3">
                                ...
                                <input type="number" class="form-control @error('bathrooms') is-invalid @enderror"
                                    ...
                                    value="{{ old('bathrooms') ?? $apartment->bathrooms }}" data-parsley-type="number"
                                    data-parsley-trigger="keyup" min="1">
                                @error('bathrooms')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                            ...
                            <div class="mb-3 col-3">
                                ...
                                <input type="number" class="form-control @error('mq') is-invalid @enderror"
                                    id="mq" name="mq" value="{{ old('mq') ?? $apartment->mq }}"
                                    data-parsley-type="number" data-parsley-trigger="keyup" min="20">
                                @error('mq')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                    ...
                    <div class="row ">
                        @foreach ($services as $service)
                            <div class="col-sm-6 col-md-4 ">
                                ...
                                <label class="form-check-label" for="service-{{ $service->id }}" required
                                    data-parsley-error-message="Insert at least one service">
                                    {{ $service->name }}
                ...
                <div class="row mt-5 mb-3">
                    <div class="col-4">
                        <img src="{{ $apartment->cover_image ? asset('/storage/' . $apartment->cover_image) : 'https://placehold.co/400' }}"
                            class="img-fluid" alt="" id="cover_image_preview">
    ...
    @section('scripts')
        <script type="text/javascript">
            ...
            var searchInput = ttSearchBox.getSearchBoxHTML().querySelector('input.tt-search-box-input');
